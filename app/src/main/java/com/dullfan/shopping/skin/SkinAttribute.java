...
import com.dullfan.shopping.skin.utils.SkinResources;
import com.dullfan.shopping.skin.utils.SkinThemeUtils;
...
public class SkinAttribute {
    ...
    static {
        ...
        mAttributes.add("itemTextColor");
        mAttributes.add("itemIconTint");
    }
            ...
            for (SkinPair skinPair : skinPairs) {
                ...
                switch (skinPair.attributeName) {
                    ...
                    case "drawableBottom":
                        ...
                        break;
                    case "itemTextColor":
                        ((BottomNavigationView) view).setItemTextColor(SkinResources.getInstance().getColorStateList
                                (skinPair.resId));
                        break;
                    case "itemIconTint":
                        ((BottomNavigationView) view).setItemIconTintList(SkinResources.getInstance().getColorStateList
                                (skinPair.resId));
                        break;
